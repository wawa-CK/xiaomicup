...
def build_plan(args):
    return [
        ...
        Segment(
            ...
            step_height=args.stone_step_height,
        ),
        Segment(
            "turn_approach",
            ...
            step_height=args.approach_step_height,
        ),
        Segment(
            "pre_turn_creep",
            ...
            step_height=args.turn_step_height,
        ),
        Segment(
            "turn_left_entry",
        ...
        Segment(
            ...
            step_height=args.curve_step_height,
        ),
        Segment(
            "curve_clear",
            args.curve_duration,
    ...
    for _ in range(ticks):
        ...
        if vision is not None and segment.name in VISION_SEGMENTS:
            ...
            active_segment = Segment(
                ...
                step_height=segment.step_height,
            )
...
def main() -> int:
    ...
    parser.add_argument("--stone-duration", type=float, default=23.0)
    parser.add_argument("--stone-speed", type=float, default=0.16)
    parser.add_argument("--stone-step-height", type=float, default=0.075)
    ...
    parser.add_argument("--approach-speed", type=float, default=0.20)
    parser.add_argument("--approach-step-height", type=float, default=0.08)
    ...
    parser.add_argument("--turn-step-height", type=float, default=0.060)
    ...
    parser.add_argument("--curve-step-height", type=float, default=0.055)
