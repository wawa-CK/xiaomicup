...
def launch_setup(context, *args, **kwargs):
    ...
    start_gazebo_client_cmd = IncludeLaunchDescription(
        ...
        condition=IfCondition(PythonExpression(
             [LaunchConfiguration('use_simulator'), ' and ', LaunchConfiguration('gui'), ' and not ', LaunchConfiguration('headless')]))# [LaunchConfiguration('use_simulator'), ' and not ', LaunchConfiguration('headless')]))
    )
